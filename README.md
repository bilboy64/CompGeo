...
Επομένως, λόγω της χρονικής πολυπλοκότητας του *O(nlogn)*, οι σταδιακές αυξήσεις στο πλήθος των διαφορετικών n σημείων επηρεάζουν *"αργά"* τον χρόνο εκτέλεσης οποιουδήποτε εκ των δύο αλγορίθμων (με την έννοια ότι, όσο αυξάνουμε το n, παρατηρούμε μικρότερες αυξήσεις στον χρόνο εκτέλεσης από ό,τι θα παρατηρούσαμε σε έναν O(n^2) αλγόριθμο, λόγω ακριβώς της συνάρτησης nlogn).   
