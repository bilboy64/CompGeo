...
python notebook αρχείο, όπου οι *Graham's Scan* και *Jarvis March* απέχουν περίπου κατά 2 με 3 microseconds (και λιγότερο), ενώ ο *QuickHull* απέχει δευτερόλεπτα από τους προηγούμενους. 
